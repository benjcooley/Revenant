...
{
    int tal[MAXTALISMANLEN];
    int cmp[MAXTALISMANLEN];
...
{
    ((PTCharacter)ch)->Damage(random(variant->mindamage, variant->maxdamage), spell->damagetype);
}
