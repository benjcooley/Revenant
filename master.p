...
begin
  ...
  BEGIN
	...
	scrollto Locke
	Locke.say "Whoever that was I think he was trying to help me."
	Locke.say "I should probably grab that talisman he was talking about."
	control on
	toggle pause=1  
     END	
...
begin
  ...
  CUBE Locke 9280,6368,0 9456,6544,144
  BEGIN
	...
	Locke.say "I better go check it out."
...
begin
  ...
  BEGIN
	...
	say "It has come to my attention that you might know something about a golden sun statue that was stolen from these dungeons."

    :Start

	Choice Admission "Are you referring to this gold sun statue?"
...
begin
  ...
  BEGIN
	...
	Locke.goto 7150 8640
	Locke.stop
	Locke.face 200
	Locke.say "Something the matter?"
	wait 24
	Locke.try combat
	say backpedal "Where.. How...Noooooooo!!!!!"
	Locke.try attack1
	try lay
	//add effect//
	Locke.try walk
	...
	Locke. face 76
	wait 12
	Locke.say "I can't let him die yet..."
	wait 12
	...
	wait 24
	say dying "I'm dying regardless"
	...
	Locke.say "Now I've got to go find that golden sun statue!"
    control on
  END
...
begin
  ...
  BEGIN
	...
	Locke.say "I made it through the dungeon with the golden sun intact."
	wait 24
	Locke.face 60
	Locke.say "What do you mean this was just a demo?"
	Locke.say "I was just getting warmed up!"
	Locke.say "You people better check out the full adventure this fall."
	Locke.say "or else...."
	newgame
   END
END

//scripts for level 48
...
BEGIN
  ...
  USE	
	...
	control off 
	locke.stop
	locke.goto 9740 9800
	locke.pos 15148 15292 
  	END
END
